let customSkillData = [];
    ...
    const skillNotes = {
      ...
      "取悦": "该技能有许多形式，包括以外貌吸引、诱惑、奉承或仅仅是依靠个人魅力。魅惑技能可用于迫使某人以某种方式行事，但不可能使其做出完全与平日作风相反的行为。这项技能可被魅惑或心理学对抗。",
      "魅惑": "该技能有许多形式，包括以外貌吸引、诱惑、奉承或仅仅是依靠个人魅力。魅惑技能可用于迫使某人以某种方式行事，但不可能使其做出完全与平日作风相反的行为。这项技能可被魅惑或心理学对抗。",
